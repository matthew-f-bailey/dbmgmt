...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('skill', models.CharField(choices=[('transplant', 'Organ Transplants'), ('wound', 'Wound Care'), ('brain', 'Brain'), ('head_trauma', 'Head Trauma'), ('clipping', 'Toenail Clipping'), ('bunion', 'Bunion Removal')], max_length=50)),
            ],
        ),
        migrations.CreateModel(
            name='Nurse',
        ...
        migrations.AddField(
            model_name='skills',
            name='surgeon',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hospital.surgeon'),
        ),
        migrations.CreateModel(
            name='Patient',
            fields=[
