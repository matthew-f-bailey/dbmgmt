...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(choices=[('transplant', 'Organ Transplants'), ('wound', 'Wound Care'), ('brain', 'Brain'), ('head_trauma', 'Head Trauma'), ('clipping', 'Toenail Clipping'), ('bunion', 'Bunion Removal')], max_length=100)),
            ],
        ),
        migrations.CreateModel(
            name='Nurse',
