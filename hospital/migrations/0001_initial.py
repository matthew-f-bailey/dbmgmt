    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('heart_risk', models.CharField(blank=True, choices=[('n', 'None'), ('l', 'Low'), ('m', 'Moderate'), ('h', 'High')], max_length=1, null=True)),
                ('allergies', models.ManyToManyField(blank=True, to='hospital.allergy')),
                ('illnesses', models.ManyToManyField(blank=True, to='hospital.illness')),
                ('pcp', models.ForeignKey(blank=True, default=hospital.models.people.Physician.get_chief_of_staff, null=True, on_delete=models.SET(hospital.models.people.get_chief_of_staff), to='hospital.physician')),
            ],
        ...
        migrations.CreateModel(
            name='InPatient',
            fields=[
                ('patient_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='hospital.patient')),
                ('admission_date', models.DateField()),
                ('assigned_nurse', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='hospital.nurse')),
